...
import { FiFolder, FiPlus, FiTrash2, FiUsers, FiSearch, FiX } from "react-icons/fi";
    ...
    return (
        <div className="px-5 py-3 space-y-6 animate-pulse">
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="h-10 w-32 bg-[#1A1A1A] rounded-[4px]"></div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[...Array(6)].map((_, i) => (
                    <div key={i} className="rounded-[4px] border border-[#2D2D2D] bg-[#0F0F0F] p-5">
                        ...
                        <div className="h-8 bg-[#1A1A1A] rounded-[4px] w-full mb-3"></div>
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p className="text-sm text-[#797979] font-dnsans">
                        Organize your security scans by project
                    </p>
                </div>
                <button
            ...
            {!isLoading && projects.length === 0 && (
                ...
                >
                    <div className="w-16 h-16 mx-auto mb-4 rounded-[4px] bg-[#1A1A1A] flex items-center justify-center">
                        <FiFolder className="w-8 h-8 text-[#797979]" />
                    </div>
                    <h3 className="text-lg font-bold text-[#E7E7E7] mb-2">No Projects Yet</h3>
                    <p className="text-sm text-[#797979] mb-6 max-w-sm mx-auto">Create your first project to organize scans and manage team access</p>
                    <button
                        onClick={() => setShowCreate(true)}
                    ...
                    {projects.map((project, i) => (
                        ...
                        >
                            ...
                            <div className="p-5">
                                <div className="flex items-start justify-between mb-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[11px] text-[#797979] mt-0.5">by {project.owner.name}</p>
                                        </div>
                                    </div>
                                    <button
                                ...
                                {project.description && (
                                    <p className="text-xs text-[#797979] mb-3 line-clamp-2">{project.description}</p>
                                )}
                    ...
                    >
                        ...
                        >
                            <div className="flex items-center justify-between px-5 py-4 bg-[#0a0a0a] border-b border-[#2D2D2D]">
                                <span className="text-[13px] font-bold text-[#E7E7E7] uppercase tracking-wider">Create New Project</span>
                                <button
                                    onClick={handleClose}
                            ...
                            <div className="p-5 space-y-4">
                                <div>
                                    <label className="block text-[11px] font-semibold text-[#797979] mb-1.5 uppercase tracking-wider">Project Name *</label>
                                    <input
                                        type="text"
                                        value={name}
